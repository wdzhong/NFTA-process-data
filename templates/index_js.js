...
function onload_func() {
    let intervalId = window.setInterval(current_time_update, 500);
    load_way_structure()
...
function get_traffic_for_selected_time() {
    ...
    let timestamp = Date.parse(picked_datetime).toString().substr(0,10);
...
function get_traffic_for_selected_time_callback(raw_json){
    traffic_info = JSON.parse(raw_json);
